...
const ContactUs = () => {
    return (
        <div className='mt-5'>
            <Marquee className='bg-emerald-700 text-amber-50 p-2 '>
                <p>Ragina Akter. Email-reginaakhter055@gmail.com , contact us : 016130***** , Address:Rangpur sadar,rangpur,mithapukur</p>
            </Marquee>


            <div className='text-center'>
                <text className="4xl text-emerald-600 font-semibold text-4xl ">Our Office Location</text>
            </div>

            <div className='flex space-x-2 mt-5'>
                <section className=''>
                    <img src="https://i.ibb.co/TD3zYNL/modern-residential-building-beautiful-recreation-area-modern-residential-building-recreation-area-13.webp" alt="" />
                </section>
                <section className=''>
                    <img src="https://images.pexels.com/photos/12954880/pexels-photo-12954880.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt="" />
                </section>

            </div>

            <div>
                <section className='font-semibold text-3xl text-emerald-500 text-center mt-5'>
                    <h1>How to contact us</h1>
                  
                </section>
                <section className='font-semibold text-emerald-500 text-center mb-5'>
                      <p>If you want to contact us directly, you can contact us by calling the
                        number given below or by emailing us directly.</p>
                </section>
            </div>
{/* form section */}
<div className=' '>
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      ...
      <p className="py-6">
       <p className='text-2xl ml-5'>Address :123 Main Street CityTown, NY 12345 Dhaka Bangladesh</p> <br />
       <p className='text-2xl ml-5'>Email :reginaakter055@gmail.com</p><br />
        ...
        <div>
            <div className="bg-orange-500 aspect-w-1 aspect-h-1">
                <div className="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                    <p clasName="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Floyd Miles</p>
